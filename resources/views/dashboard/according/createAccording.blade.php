...
@section('title')New According| Abdullah Un Noman | UI/UX Expert @endsection
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-light">
                           <h3 class="text-dark">Add New According</h3>
                        </div>
                    ...
                    <div class="alert alert-primary">{{Session::get('success')}}</div>
                        ...
                        @endif
                    <form method="POST" action="{{route('createAccordingSubmit')}}" enctype = 'multipart/form-data'>
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input id="normal-input" class="form-control" name="job_title" placeholder="Job Title">
                                    </div>
                                    <div class="form-group">
                                        <label for="normal-input" class="form-control-label"><h5 class="text-dark">Job Office :</h5></label>
                                        <input id="normal-input" class="form-control" name="job_office" placeholder="Job Office">
                                    </div>
                                </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" cols="30" name="discription" id="editor" placeholder="Discription of your exprience"  rows="10"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input id="normal-input" type="date" class="form-control" name="join_date" >
                            </div>
                                </div>
                                <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input id="normal-input" class="form-control" type="date" name="resign_date">
                            </div>
                                </div>
                            </div>
