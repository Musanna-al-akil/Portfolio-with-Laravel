            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="alert alert-primary">{{Session::get('success')}}</div>
                        ...
                        @endif
                    <form method="POST" action="{{route('createPostSubmit')}}" enctype = 'multipart/form-data'>
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label for="normal-input" class="form-control-label"><h5 class="text-dark">Post Title</h5></label>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="placeholder-input" class="form-control-label"><h5 class="text-dark">Post Content</h5></label>
